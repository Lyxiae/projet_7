<template>
  <div id="app">
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-custom">
      <div>
        <router-link v-if="userId != 0" to="/" class="navbar-brand"
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item" v-if="userId != 0">
            <router-link :to="'/posts/user/' + userId" class="nav-item"
              >Mes messages</router-link
            >
          </li>
          <li class="nav-item" v-if="userId != 0">
            <router-link to="/addpost" class="nav-item"
    ...
    <div class="container main-app">
      <div class="row">
        ...
        <div class="col-md-10 py-3" v-bind:class="{ 'col-12': userId != 0 }">
          <router-view />
        </div>
      </div>
    </div>
