    ...
    <section class="container">
        ...
        <form id="post-form" name="post-form">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="postTitle" name="postTitle" v-model="title" placeholder="Titre du post">
            </div>
            ...
            <button class="btn btn-success" @click.once.prevent="savePost">Poster</button>
        </form>
    </section>
</template>
